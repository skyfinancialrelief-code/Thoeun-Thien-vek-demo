...
4. **No License Granted**: This disclosure and repository submission do not grant any express or implied patent license, commercial software license, or trademark authorization to any party, except for the standard review rights granted to competition organizers and judges.

5. **Third-Party & Open-Source Components**: All third-party libraries (e.g. Express, React, Vite, Tailwind CSS, Lucide icons) remain subject to their respective open-source licenses (MIT, Apache 2.0).
